...
import type { PathEntityEditor } from './path-entity-editor';

export interface DreamGlowsUiContext { pinia: Pinia; pathCommands: PathCommandPort; entityEditor: PathEntityEditor }
