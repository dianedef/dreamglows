...
| `packages/path_core_dart/**` | `packages/path_core_dart/README.md` | `shipglows_data/technical/common-model-adoption.md`, `windows_app/README.md` | `dart test`, `dart analyze`, shared fixtures and cross-language runner | Dart document, command, migration or package boundary changes |
| `packages/path_flutter/**` | `packages/path_flutter/README.md` | `shipglows_data/technical/common-model-adoption.md`, `shipglows_data/technical/design-system-authority.md`, Windows and Android READMEs | Flutter tests and analysis, managed Windows and Android runtime proof | Shared forms, adaptive layout, local storage, lifecycle access or theme changes |
