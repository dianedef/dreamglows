...
🟠 [DreamGlows] task: Définir et versionner le modèle de données ouvert commun | status: todo | area: product-foundation | id: open-domain-model | depends_on: dreamglows-capability-map | acceptance: Schéma documenté pour rêve, pourquoi, objectif, jalon, action, habitude, preuve, bilan, relations, révisions et migrations
...
🟠 [DreamGlows] task: Harmoniser le parcours rêve → pourquoi → chemin → prochaine action | status: todo | area: product-core | id: shared-core-journey | depends_on: open-domain-model | acceptance: Le même sens, le même chemin et le même progrès sont compris sur chaque surface livrée
